...
public class DataPanel implements ActionListener{
    ...
    DataPanel(JFrame newFrame) {
        ...
        paramLabels[orderIndex] = new JLabel("Order of polynomials");
        ...
        paramFields[orderIndex] = new JTextField("3");
        frame = newFrame;
    ...
    private boolean readFile(File datafile) {
        ...
        for (int i = 0; i < numRead; i++) {
            ...
            } else if (segments[0].equals("Order")) {
                thisCase = orderIndex;
        ...
        int showPoints = (dataFields == null) ? 0 : thisDataPoint;
    ...
    void refreshData() {
        ...
        order = Integer.parseInt(paramFields[orderIndex].getText());
